# LummaStealer remote code injection
...
// try to dump remote code injection
...
<p><img src="{{ site.url }}{{ site.baseurl }}/scripts/x64dbg/01-lummastealer_remote_code_injection.png" alt="lummastealer remote code injection output" width="100%"/></p>